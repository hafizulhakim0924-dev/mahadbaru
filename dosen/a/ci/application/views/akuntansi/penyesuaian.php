...
<!-- Page Heading -->
  <div class="d-sm-flex justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Penyesuaian</h1>
  ...
  <div class="col">
    ...
    <div class="box" id="print-section">
        <div class="box-body ">
            ...
            ?>
            <?php echo form_open('statements/create_journal_voucher_adj',$attributes); ?>
            <div class="">
                    ...
                    <div class="col-md-12 ">
                        <div class="form-group">
                            <?php echo form_label('Rincian Transaksi'); ?>
                             <?php
                                $data = array('class'=>'form-control input-lg','type'=>'text','name'=>'description');
                        ...
                        <div class="form-group">
                             ...
                             <?php
                                $data = array('class'=>'form-control input-lg','type'=>'hidden','name'=>'journal_type', 'value'=>'1');
                                echo form_input($data);
                            ?>
                        </div>                     
                        <div class="form-group">
