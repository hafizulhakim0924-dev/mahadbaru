...
class Accounts extends CI_Controller
{
    ...
    $this->load->view('akuntansi/daftar_akun.php', $data);
    $this->load->view('templates/footer');
     ...
     public function chart_of_account()
     {
      ...
      $revenue_type = html_escape($this->input->post('revenue_type'));
      ...
      $args = array(
       ...
       'revenue_type' => ($nature == 'Revenue' ? $revenue_type : '')
      );
      ...
      $args = array(
       ...
       $data = array(
        ...
        'type' => $edit_type,
         ...
         'revenue_type' => ($edit_nature == 'Revenue' ? $revenue_type : '')
       );
